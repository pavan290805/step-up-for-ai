  ...
  if (submitted) return (
    <>
      <style>{`
        ...
        .ns-card { background: linear-gradient(145deg,rgba(13, 7, 24,.9),rgba(8, 4, 26,.9)); border:1px solid rgba(168, 85, 247,.3); border-radius:24px; padding:56px 48px; text-align:center; max-width:440px; width:100%; }
        .ns-icon { font-size: 56px; margin-bottom: 20px; }
        .ns-title { font-size: 24px; font-weight: 800; color: #86efac; margin-bottom: 10px; }
        .ns-sub { font-size: 14px; color: #7c6d9e; margin-bottom: 28px; line-height: 1.6; }
        .ns-btn { display: inline-block; padding: 12px 28px; border-radius: 12px; background: linear-gradient(135deg, #a855f7, #7c3aed); color:#fff; font: 700 13px Inter; text-decoration: none; transition: all .2s; }
  ...
  return (
    <>
      <style>{`
        ...
        .nl-back { display: inline-flex; align-items: center; gap: 6px; color: #7c6d9e; font: 600 13px Inter; text-decoration: none; margin-bottom: 16px; transition: color .15s; }
        .nl-back:hover { color: #c084fc; }
        .nl-title { font-size: 26px; font-weight: 800; color: #f1eeff; letter-spacing: -.02em; }
        .nl-sub { color: #7c6d9e; font-size: 14px; margin-top: 6px; }
        .nl-card { background: linear-gradient(145deg, rgba(13, 7, 24,.9), rgba(8, 4, 26,.9)); border: 1px solid rgba(168, 85, 247,.15); border-radius: 22px; padding: 32px; margin-bottom: 22px; }
        .nl-card-title { font-size: 15px; font-weight: 700; color: #e2d9ff; margin-bottom: 22px; display: flex; align-items: center; gap: 8px; }
        .nl-card-title span { width: 28px; height: 28px; border-radius: 8px; background: rgba(168, 85, 247,.2); display: grid; place-items: center; font-size: 14px; }
        ...
        .nl-label { font-size: 12px; font-weight: 600; color: #9d7ec7; letter-spacing: .03em; text-transform: uppercase; }
        .nl-input, .nl-select, .nl-textarea { width: 100%; padding: 12px 14px; border-radius: 11px; background: rgba(255,255,255,.03); border: 1px solid rgba(168, 85, 247,.15); color: #f1eeff; font: 500 13.5px Inter; outline: none; transition: border-color .2s, box-shadow .2s; }
        .nl-input::placeholder, .nl-textarea::placeholder { color: #4a3f5c; }
        .nl-input:focus, .nl-select:focus, .nl-textarea:focus { border-color: rgba(168, 85, 247,.55); box-shadow: 0 0 0 4px rgba(168, 85, 247,.12); }
        .nl-select option { background: #0d0718; }
        .nl-textarea { resize: vertical; min-height: 130px; line-height: 1.6; }
        .nl-skills-row { display: flex; flex-wrap: wrap; gap: 8px; }
        .nl-skill-tag { padding: 6px 14px; border-radius: 8px; background: rgba(168, 85, 247,.15); border: 1px solid rgba(168, 85, 247,.3); color: #c084fc; font: 600 12px Inter; display: flex; align-items: center; gap: 6px; }
        .nl-skill-x { cursor: pointer; color: #7c6d9e; font-size: 14px; transition: color .15s; }
        .nl-skill-x:hover { color: #f87171; }
        .nl-skill-add { padding: 6px 14px; border-radius: 8px; border: 1px dashed rgba(168, 85, 247,.3); background: transparent; color: #7c6d9e; font: 600 12px Inter; cursor: pointer; transition: all .15s; }
        .nl-skill-add:hover { border-color: rgba(168, 85, 247,.6); color: #c084fc; }
        .nl-perks-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
        .nl-perk-toggle { display: flex; align-items: center; gap: 10px; padding: 12px 14px; border-radius: 12px; background: rgba(255,255,255,.02); border: 1px solid rgba(168, 85, 247,.12); cursor: pointer; transition: all .15s; }
        .nl-perk-toggle:hover { border-color: rgba(168, 85, 247,.3); background: rgba(168, 85, 247,.06); }
        .nl-perk-cb { width: 16px; height: 16px; accent-color: #a855f7; }
        .nl-perk-label { font-size: 13px; color: #c4b5e4; }
        .nl-submit-row { display: flex; gap: 14px; align-items: center; margin-top: 8px; }
        .nl-submit-btn { padding: 14px 36px; border-radius: 12px; background: linear-gradient(135deg, #a855f7, #7c3aed); color: #fff; font: 700 14px Inter; border: none; cursor: pointer; transition: all .2s; box-shadow: 0 10px 28px rgba(168, 85, 247,.38); }
        .nl-submit-btn:hover { transform: translateY(-2px); box-shadow: 0 14px 36px rgba(168, 85, 247,.5); }
        .nl-draft-btn { padding: 14px 24px; border-radius: 12px; background: transparent; border: 1px solid rgba(168, 85, 247,.3); color: #c084fc; font: 600 14px Inter; cursor: pointer; transition: all .15s; }
        .nl-draft-btn:hover { background: rgba(168, 85, 247,.08); }
